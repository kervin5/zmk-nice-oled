...
/* Forward declarations — draw helpers that will be moved from screen_peripheral.c in Task 6 */
...
/* Stub implementations — to be replaced with real code from screen_peripheral.c in Task 6 */
static void draw_background(lv_obj_t *canvas) {}
static void draw_output_status(lv_obj_t *canvas, const struct status_state *state) {}
static void draw_battery_status_peripheral(lv_obj_t *canvas, const struct status_state *state) {}
static void rotate_canvas(lv_obj_t *canvas, lv_color_t cbuf[]) {}
